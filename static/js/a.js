...
(function() {
  ...
  /*
   * ===================== Loading Skin ===========================
   * This section cheks if a skin URL parameter exists and if so dynamically loads css file 
   * with she same name from common/css/skins directory .
   * in the .ready function the colors for skin are also being loaded from skinColors object
   */
  ...
  var skin = _getParameterByName('skin');
  ...
  if(skin) {
      ...
      {
          // create a css tag and append it to the html head tag.
          var head  = document.getElementsByTagName('head')[0];
          var link  = document.createElement('link');
          link.id   = cssId;
          link.rel  = 'stylesheet';
          link.type = 'text/css';
          link.href = 'common/css/skins/' + skin + '.css';
          link.media = 'all';
  ...
  var skinColors = {
    historylab: {
      colors: ["",  '28,144,153','166,189,219','103,169,207', "190, 186, 218", "252, 205, 229", "217, 217, 217"],
      hexColors: ["", '#1c9099','#a6bddb','#67a9cf', "#8C564B", "#E377C2", "#7F7F7F", "#BCBD22", "#17BECF"]
    }
  }
  ...
  $(document).ready(function() {
    ...
    //if skin parameter and corresponding colors exist set them as color/hexColor
    if(skin && skinColors[skin] && skinColors[skin].colors && skinColors[skin].hexColors) {
      colors = skinColors[skin].colors;
      hexColors = skinColors[skin].hexColors;
    }
    ...
    getHash = function() {
      ...
      // remove skin url parameter. otherwise it breaks JSON.parse(link)
      link = link ? link.replace(/skin=?[\w]+/g, "") : ""; 
