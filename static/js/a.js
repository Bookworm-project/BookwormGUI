$(document).ready(function(){
  ...
  initializeSelectBoxes = function() {
    ...
    if (t == "date_month" || time_array.length == 1) {
	  ...
	  _(data).each(function(s,i){
        ...
        if (myt == "month") {
		      ...
		      var opts = {
		        n: i,
		        t: year,
		        str: date.toDateString().substring(4,7) + " " + date.toDateString().substring(11,15)
		      };
		      sdata.push({x: date.getTime(), y:parseFloat(vals[year]), opts: opts});
        }
        else if (myt == "author_age") {
          var opts = {
            n: i,
		        t: year,
		        str: year
        ...
        else if (myt.indexOf("_round") != -1) {
                var opts = {
                        n: i,
                        t: year,
                        str: year
                };
                sdata.push({x: Date.UTC(0, 0, year), y:parseFloat(vals[year]), opts: opts});
        }
        else if (myt.indexOf("_cycle") != -1) {
                var opts = {
                        n: i,
                        t: year,
                        str: year
                };
                sdata.push({x: Date.UTC(2000, 0, year), y:parseFloat(vals[year]), opts: opts});
        }
